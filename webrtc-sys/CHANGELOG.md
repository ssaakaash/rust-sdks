...
## [0.3.10](https://github.com/ssaakaash/rust-sdks/compare/rust-sdks/webrtc-sys@0.3.9...rust-sdks/webrtc-sys@0.3.10) - 2025-09-01

### Added

- VA-API support for linux. ([#638](https://github.com/ssaakaash/rust-sdks/pull/638))

### Fixed

- change search_dirs to use cc --print-search-dirs instead of clang --print-search-dirs
- hardware rendering ([#695](https://github.com/ssaakaash/rust-sdks/pull/695))
# Changelog
